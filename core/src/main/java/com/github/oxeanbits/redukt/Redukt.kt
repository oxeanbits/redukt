...
import com.github.oxeanbits.redukt.middlewares.DebugMiddleware
import com.github.oxeanbits.redukt.middlewares.Middleware
import com.github.oxeanbits.redukt.reducers.Reducer
import com.github.oxeanbits.redukt.states.StateListener
import com.github.oxeanbits.redukt.utils.createLinkedMap
...
class Redukt<T>(state: T, val debug: Boolean = false) {
    ...
    private fun addDebugMiddleware() {
        ...
        middlewares["com.github.oxeanbits.redukt.debugMiddleware"] = debugMiddleware
